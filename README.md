...
本項目基於：[初叶🍂 MetingAPI 点歌插件](https://github.com/chuyegzs/astrbot_plugin_meting)
...
- **可选值**：
  ...
  - `https://musicapi.chuyel/api/` - 這個應該也是初叶的 但應該是免費版本的大概
  - `custom` - 自定义 API 你自己架的MetingAPI或指向某人架的
...
或者直接到[Discord群]("https://discord.gg/jud4UE6wuq")反饋
